...
def add_item( action="" , title="" , plot="" , url="" , thumbnail="" , fanart="" , genre="", date="", credits="", show="" , episode="" , extra="", page="", sort=False, info_labels = None, isPlayable = False , folder=True ):
    ...
    #if url.startswith("plugin://"):  ##Original
    if url.startswith("plugin://") and genre != "NOGESTIONAR":
        itemurl = url
...
if sys.version_info[0] < 3:
    ...
    f = open( os.path.join( os.path.dirname(__file__) , "addon.xml"), "r", encoding='utf-8' )
