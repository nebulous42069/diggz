...
DEBRIDID = {
    ...
    'adina': {
        ...
        'file'     : os.path.join(CONFIG.NONDEBRIDFOLD, 'adina_nondebrid'),
    ...
    'artemis': {
        ...
        'file'     : os.path.join(CONFIG.NONDEBRIDFOLD, 'artemis_nondebrid'),
        ...
        'default_file'  : 'filepursuit.api',
        'data'     : ['furk.username', 'furk.password', 'furk.api', 'easynews.username', 'easynews.password', 'filepursuit.api', 'furk.priority', 'easynews.priority', 'filepursuit.priority'],
    ...
    'dynasty': {
        ...
        'file'     : os.path.join(CONFIG.NONDEBRIDFOLD, 'dyna_nondebrid'),
    ...
    'loonatics': {
        ...
        'file'     : os.path.join(CONFIG.NONDEBRIDFOLD, 'loon_nondebrid'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.le', 'settings.xml'),
        'default'  : '',
        'default_furk'  : 'furk.username',
        'default_easy'  : '',
        'default_file'  : '',
        'data'     : ['furk.username', 'furk.password', 'furk.api'],
   ...
   'thepromise': {
        ...
        'file'     : os.path.join(CONFIG.NONDEBRIDFOLD, 'thepromise_nondebrid'),
   ...
   'nine': {
    ...
    'yact': {
        ...
        'file'     : os.path.join(CONFIG.NONDEBRIDFOLD, 'yact_nondebrid'),
