...
site_list = [
    ...
    {'title': 'Chuck', 'url': 'https://watchchuckonline.com', 'endings': ['/seasons/'], 'image': 'https://i.ibb.co/34cGL8L/Chuck-min.jpg'},
    ...
    {'title': 'Glee (Random ONLY)', 'url': 'https://watchgleeonline.com', 'endings': ['/seasons/'], 'image': 'https://i.ibb.co/gzqn1hs/glee-min.jpg'},
    ...
    {'title': 'Mad Men (Random ONLY)', 'url': 'https://watchmadmenonline.com', 'endings': ['/seasons/'], 'image': 'https://i.ibb.co/TTc2B2k/mad-men-min.jpg'},
    {'title': 'Malcolm In The Middle (Random ONLY)', 'url': 'https://watchmalcolminthemiddle.com', 'endings': ['/seasons/'], 'image': 'https://i.ibb.co/S07hWLt/malcolm-in-the-middle-min.jpg'},
    ...
    {'title': 'Monk (Random ONLY)', 'url': 'https://watchmonkonline.com', 'endings': ['/seasons/'], 'image': 'https://i.ibb.co/TMtCncc/monk-min.jpg'},
    ...
    {'title': 'Smallville (Random ONLY)', 'url': 'https://watchsmallvilleonline.net', 'endings': ['/seasons/'], 'image': 'https://i.ibb.co/qF7FHKS/smallville-min.jpg'},
    ...
    {'title': 'The Mentalist (Random ONLY)', 'url': 'https://watchthementalistonline.com', 'endings': ['/seasons/'], 'image': 'https://i.ibb.co/mFVFtgL/the-mentalist-min.jpg'},
