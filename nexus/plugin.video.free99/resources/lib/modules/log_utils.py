...
ChangeLog_head = '--[ [COLOR darkorange]Free99 - %s [/COLOR]ChangeLog ]--' % version
DebugLog_head = '--[ [COLOR darkorange]Free99 - %s [/COLOR]DebugLog ]--' % version
DEBUGPREFIX = '[ [COLOR darkorange]Free99 - %s - DEBUG[/COLOR] ]' % version
