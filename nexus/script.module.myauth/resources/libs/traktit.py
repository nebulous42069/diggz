...
def revoke_trakt(): #Restore default API keys to all add-ons
    ...
    if xbmcvfs.exists(var.check_addon_seren): #Check if add-on is installed
    ...
    if xbmcvfs.exists(var.check_addon_fen):
    ...
    if xbmcvfs.exists(var.check_addon_pov):
    ...
    if xbmcvfs.exists(var.check_addon_umb):
    ...
    if xbmcvfs.exists(var.check_addon_home):
    ...
    if xbmcvfs.exists(var.check_addon_genocide):
    ...
    if xbmcvfs.exists(var.check_addon_crew):
    ...
    if xbmcvfs.exists(var.check_addon_shazam):
    ...
    if xbmcvfs.exists(var.check_addon_night):
    ...
    if xbmcvfs.exists(var.check_addon_promise):
    ...
    if xbmcvfs.exists(var.check_addon_scrubs):
    ...
    if xbmcvfs.exists(var.check_addon_alvin):
    ...
    if xbmcvfs.exists(var.check_addon_shadow):
    ...
    if xbmcvfs.exists(var.check_addon_ghost):
    ...
    if xbmcvfs.exists(var.check_addon_unleashed):
    ...
    if xbmcvfs.exists(var.check_addon_chains):
    ...
    if xbmcvfs.exists(var.check_addon_md):
    ...
    if xbmcvfs.exists(var.check_addon_asgard):
    ...
    if xbmcvfs.exists(var.check_addon_myaccounts):
    ...
    if xbmcvfs.exists(var.check_addon_tmdbh):
    ...
    if xbmcvfs.exists(var.check_addon_trakt):
