...
class Config:
    ...
    def init_varss(self):
        ...
        # Themeing Menu Items
        self.ICON709 = vars.ICON709 if not vars.ICON709.endswith('://') else self.ADDON_ICON
        self.ICONSAVE = vars.ICONSAVE if not vars.ICONSAVE.endswith('://') else self.ADDON_ICON
        self.ICONTRAKT = vars.ICONTRAKT if not vars.ICONTRAKT.endswith('://') else self.ADDON_ICON
        self.ICONDEBRID = vars.ICONREAL if not vars.ICONREAL.endswith('://') else self.ADDON_ICON
