...
DEBRIDID = {
    'seren': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.seren', 'settings.xml'),
    ...
    'ezra': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.ezra', 'settings.xml'),
        'default_rd'  : 'rd.username',
    ...
    'umb': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.umbrella', 'settings.xml'),
    ...
    'shadow': {
       ...
       'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.shadow', 'settings.xml'),
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.shadow', 'settings.xml'),
        'default_rd'  : 'rd.client_id',
    ...
    'ghost': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.ghost', 'settings.xml'),
        'default_rd'  : 'rd.client_id',
        'default_pm'  : 'premiumize.token',
        'default_ad'  : 'alldebrid.username',
        'data'     : [],
    ...
    'chains': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.thechains', 'settings.xml'),
        'default_rd'  : 'rd.client_id',
        'default_pm'  : 'premiumize.token',
        'default_ad'  : 'alldebrid.username',
        'data'     : [],
    ...
    'twisted': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.twisted', 'settings.xml'),
        'default_rd'  : 'rd.client_id',
        'default_pm'  : 'premiumize.token',
        'default_ad'  : 'alldebrid.username',
        'data'     : [],
    ...
    'base19': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.base19', 'settings.xml'),
        'default_rd'  : 'rd.client_id',
        'default_pm'  : 'premiumize.token',
        'default_ad'  : 'alldebrid.username',
        'data'     : [],
    ...
    'md': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.magicdragon', 'settings.xml'),
        'default_rd'  : 'rd.client_id',
        'default_pm'  : 'premiumize.token',
        'default_ad'  : 'alldebrid.username',
        'data'     : [],
    ...
    'asgard': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.asgard', 'settings.xml'),
        'default_rd'  : 'rd.client_id',
        'default_pm'  : 'premiumize.token',
        'default_ad'  : 'alldebrid.username',
        'data'     : [],
    ...
    'metv': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.metv19', 'settings.xml'),
        'default_rd'  : 'rd.client_id',
        'default_pm'  : 'premiumize.token',
        'default_ad'  : 'alldebrid.username',
        'data'     : [],
    ...
    'myact': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'script.module.myaccounts', 'settings.xml'),
    ...
    'rurl': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, 'script.module.resolveurl', 'settings.xml'),
    ...
    'acctmgr': {
        ...
        'bk_settings' : os.path.join(CONFIG.ADDON_DATA, '', ''),
        'default_rd'  : 'realdebrid.username',
        'default_pm'  : 'premiumize.username',
        'default_ad'  : 'alldebrid.username',
        'data'     : [],
...
def update_debrid(do, who):
    ...
    bk_settings = DEBRIDID[who]['bk_settings']
    ...
    default_pm = DEBRIDID[who]['default_pm']
    default_ad = DEBRIDID[who]['default_ad']
    user = addonid.getSetting(default)
    ...
    if do == 'update':
        ...
        logging.log('{0} SETTINGS: {1}'.format(name, bk_settings))
        if os.path.exists(bk_settings):
            try:
                tree = ElementTree.parse(bk_settings)
                root = tree.getroot()
