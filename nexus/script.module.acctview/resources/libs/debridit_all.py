...
DEBRIDID = {
    ...
    'adina': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_RD, 'adina'),
    ...
    'artemis': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_RD, 'artemis'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.artemis', 'settings.xml'),
        'default_rd'  : 'realdebrid.client_id',
        'default_pm'  : 'premiumize.token',
        'default_ad'  : 'alldebrid.username',
    ...
    'dyna': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_RD, 'dyna'),
    ...
    'loon': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_RD, 'loon'),
