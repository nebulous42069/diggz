...
DEBRIDID = {
    ...
    'povad': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'pov_ad'),
    ...
    'unleashedad': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'unleashed_ad'),
   ...
   'acctmgrad': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'acctmgr_ad'),
